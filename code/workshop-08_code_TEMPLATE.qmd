...
The best model that best predicts total plant mass (g) includes water treatment and species (F(7,62) = 27.08, p < 0.001, $\alpha$ = 0.05), but not SLA. 
